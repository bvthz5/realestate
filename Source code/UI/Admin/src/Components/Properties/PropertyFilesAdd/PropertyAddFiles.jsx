...
const PropertyAddFiles = () => {
  ...
  function validateFile(image) {
    ...
    if (!isValidFile) {
      Swal.fire("Allowed Extensions are : *." + allowedExtension.join(", *."));
    }
  ...
  async function upload(e) {
    ...
    try {
      ...
      const response = await Axious.post(
        `/api/image/add-new/property/${propertyId}`,
        data,
        {
          headers: {
...
export default PropertyAddFiles;
